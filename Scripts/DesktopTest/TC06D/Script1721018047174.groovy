...
Windows.waitForElementPresent(findWindowsObject('DesktopWikipedia/input_SearchWikipedia'), 0)

Windows.delay(2)

Windows.click(findWindowsObject('DesktopWikipedia/input_SearchWikipedia'))

Windows.setText(findWindowsObject('DesktopWikipedia/input_SearchWikipedia'), 'Kaylie Jenner')
