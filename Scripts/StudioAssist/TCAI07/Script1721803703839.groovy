...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_username'), 'your_username')
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_password'), 'your_password')
