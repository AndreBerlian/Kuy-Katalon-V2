...
WebUI.click(findTestObject('Object Repository/CURA/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'))

WebUI.click(findTestObject('Object Repository/CURA/Page_CURA Healthcare Service/td_31'))

WebUI.setText(findTestObject('Object Repository/CURA/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Comment For Me\nSelf Healing')
